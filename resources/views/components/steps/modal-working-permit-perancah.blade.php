...
>
    <div 
        ...
        class="bg-white p-6 rounded-lg shadow-lg wp-permit-form w-full max-w-6xl overflow-y-auto max-h-[90vh]"
    >
        <h2 class="text-lg font-bold mb-4 text-gray-800 border-b pb-2">{{ $label ?? 'Form Working Permit Perancah' }}</h2>

        {{-- ✅ Include form blade permit perancah --}}
        @include('components.permits.perancah', [
            'permit' => $permitPerancah ?? null,
            'detail' => $detail ?? null,
