...
>
    ...
    >
        <h2 class="text-lg font-bold mb-4 text-gray-800 border-b pb-2">Edit Working Permit Penggalian</h2>

        {{-- Include langsung permit penggalian --}}
        @include('components.permits.penggalian', [
            'permit' => $permitPenggalian ?? null,
