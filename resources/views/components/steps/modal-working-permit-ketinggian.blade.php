<div x-show="activeModal === '{{ $id }}'" x-cloak
    ...
    <div @click.away="activeModal = null"
        class="bg-white p-6 rounded-lg shadow-lg wp-permit-form w-full max-w-5xl overflow-y-auto max-h-[90vh]">

        <h2 class="text-lg font-bold mb-4 text-gray-800 border-b pb-2">Edit Working Permit Ketinggian</h2>
        ...
        <div class="flex justify-end gap-2 mt-6">
            <button type="button" @click="activeModal = null"
                class="px-4 py-2 bg-gray-300 rounded hover:bg-gray-400 text-sm">Tutup</button>
        </div>
    </div>
</div>
