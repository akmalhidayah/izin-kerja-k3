...
@php
    $detail = \App\Models\WorkPermitDetail::where('notification_id', $notification->id)->first();
    $closure = $closure ?? ($detail ? \App\Models\WorkPermitClosure::where('work_permit_detail_id', $detail->id)->first() : null);
