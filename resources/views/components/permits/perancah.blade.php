...
<table class="table-auto w-full border text-sm mt-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="border px-2 py-1 font-semibold" colspan="1">
                Sketsa perancah yang akan dibangun:<br>
                <span class="text-gray-400 text-xs italic">(Bisa lampiran terpisah)</span>
            </td>
        </tr>
        <tr>
            <td class="border px-2 py-1">
            ...
            <td class="border px-2 py-1">
                <textarea name="sketsa_perancah" class="textarea w-full text-sm" rows="8">{{ old('sketsa_perancah', $permit->sketsa_perancah ?? '') }}</textarea>
            </td>
        </tr>
        <tr>
...
<div class="border border-gray-800 rounded-md p-4 bg-white shadow overflow-x-auto mt-6 text-sm">
    ...
    <table class="table-auto w-full text-sm border mt-3">
        ...
        <tbody>
            <tr>
                <td class="border px-2 py-2 text-center">
                    <input type="text" name="scaffolding_verificator_name" class="input w-full text-xs text-center"
                        placeholder="Nama"
                        value="{{ old('scaffolding_verificator_name', $permit->scaffolding_verificator_name ?? '') }}">
                </td>
                <td class="border px-2 py-2 text-center">
                    <input type="text" name="permit_issuer_name" class="input w-full text-center text-xs"
                        placeholder="Nama"
                        value="{{ old('permit_issuer_name', $permit->permit_issuer_name ?? '') }}">
                </td>
                <td class="border px-2 py-2 text-center">
                    <input type="text" name="permit_authorizer_name" class="input w-full text-center text-xs"
                        placeholder="Nama"
                        value="{{ old('permit_authorizer_name', $permit->permit_authorizer_name ?? '') }}">
                </td>
            </tr>
