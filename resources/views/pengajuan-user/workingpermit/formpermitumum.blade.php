                ...
                <template x-for="(item, index) in listrik" :key="index">
                    <tr>
                        ...
                        <td class="border p-1 text-center">
                            ...
                            <button type="button" @click="openSignPad(`signature_listrik_${index}`)" class="wp-signature-button inline-flex h-8 w-28 items-center justify-center whitespace-nowrap rounded bg-blue-600 px-3 py-1 text-xs font-semibold text-white shadow-sm hover:bg-blue-700" x-text="item.signature ? 'Ubah TTD' : 'Tanda Tangan'"></button>
                        </td>
                    </tr>
                </template>
            </tbody>
                ...
                <template x-for="(item, index) in nonListrik" :key="index">
                    <tr>
                        ...
                        <td class="border p-1 text-center">
                            ...
                            <button type="button" @click="openSignPad(`signature_nonlistrik_${index}`)" class="wp-signature-button inline-flex h-8 w-28 items-center justify-center whitespace-nowrap rounded bg-blue-600 px-3 py-1 text-xs font-semibold text-white shadow-sm hover:bg-blue-700" x-text="item.signature ? 'Ubah TTD' : 'Tanda Tangan'"></button>
                        </td>
                    </tr>
                </template>
            </tbody>
