        ...
        <tbody>
            <tr>
                ...
                <td class="border text-center px-2 py-2">
                    ...
                    @endif
                    <button type="button" onclick="openSignPad('ketinggian_token_signature_close_requestor')" class="text-blue-600 underline text-xs">
                ...
                <td class="border text-center px-2 py-2">
                    ...
                    @endif
                    <button type="button" onclick="openSignPad('ketinggian_token_signature_close_issuer')" class="text-blue-600 underline text-xs">
