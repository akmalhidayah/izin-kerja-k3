<x-admin-layout>
    <div class="min-w-0 rounded-2xl border border-gray-200 bg-gradient-to-r from-red-50 via-white to-amber-50 p-4 shadow-sm mb-6 sm:p-6">
        <div class="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
            <div class="min-w-0">
                <div class="flex min-w-0 items-start gap-2 sm:items-center">
                    <span class="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-red-600 text-white shadow">
                        <svg viewBox="0 0 24 24" class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="1.8">
                            <path d="M4 5h16v5H4zM4 13h9v6H4zM15 13h5v6h-5z" />
                        </svg>
                    </span>
                    <h1 class="min-w-0 break-words text-xl font-extrabold leading-tight text-red-700 sm:text-2xl lg:text-3xl">Permintaan Izin Kerja Vendor</h1>
                </div>
    ...
    <form method="GET" action="{{ route('admin.permintaansik') }}"
        ...
        <div class="flex w-full flex-col gap-2 sm:flex-row sm:items-center">
            <button type="submit" class="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-red-600 px-4 py-2 text-xs text-white hover:bg-red-700 sm:w-auto">
                <svg viewBox="0 0 24 24" class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2">
