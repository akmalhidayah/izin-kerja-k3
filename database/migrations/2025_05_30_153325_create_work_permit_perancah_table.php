...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('work_permit_perancah', function (Blueprint $table) {
            ...
            $table->enum('close_lock_tag', ['ya', 'na'])->nullable();
            $table->enum('close_sampah_peralatan', ['ya', 'na'])->nullable();
            $table->enum('close_machine_guarding', ['ya', 'na'])->nullable();
            $table->date('close_date')->nullable();
            $table->time('close_time')->nullable();
            $table->string('signature_close_requestor')->nullable();
            $table->string('signature_close_issuer')->nullable();
            $table->timestamps();
        });
    }
